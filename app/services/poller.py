...
async def run_recursive_sync():
    ...
    if not sync_run: return
    logger.info("Starting SentinelQAPortal sync for project %s", settings.zephyr_project_key)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SentinelQAPortal Poller")
